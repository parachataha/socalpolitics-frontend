...
const Form = ( {currentQuery} ) => {
    ...
    return ( 
        <form onSubmit={(e) => handleSearch(e)} className='mt-3 mb-5 pb-6 search-form text-center'>
            ...
            <div className='pt-3 text-center'>
                <Link className='mr-1 button button-red' href={`/location/${query}`}>Search By Location</Link>
